...
// Add this above the GitHubStarsButton return
const FlyingStars = () => {
  const starsArray = Array.from({ length: 8 });
  return (
    <>
      {starsArray.map((_, i) => {
        const angle = (i / starsArray.length) * 2 * Math.PI;
          ...
          <motion.div
            ...
            animate={{
              x: [
                ...
                radius * Math.cos(angle + Math.PI / 4),
                0,
              ],
              y: [
                0,
                radius * Math.sin(angle),
                radius * Math.sin(angle + Math.PI / 4),
                0,
              ],
              opacity: [0, 1, 1, 0],
            }}
